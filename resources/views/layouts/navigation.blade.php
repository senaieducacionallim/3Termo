<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Corrigido: routeIs deve usar o padrão 'nome.index' ou 'nome*' -->
            ...
            </div> <!-- Fim do bloco da esquerda (Logo + Links) -->

            <!-- Settings Dropdown (Agora dentro do flex justify-between) -->
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- Adicione os outros links aqui também para o menu mobile funcionar -->
